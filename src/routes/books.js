...
router.get('/search', (req, res) => {
  request
    .get(`https://www.goodreads.com/search/index.xml?key=${process.env.GODREADS_KEY}&q=${req.query.q}`)
    .then(result =>
...
router.get('/fetchPages', (req, res) => {
  ...
  request
    .get(`https://www.goodreads.com/book/show.xml?key=${process.env.GODREADS_KEY}&id=${goodreadsId}`)
    .then(result =>
      parseString(result, (err, goodreadsResult) => {
